...
class LecturethController extends Controller
{
  ...
  public function alllecture()
  {
    ...
    $all_Lectures = Lecture::whereNull('chapter_id')->where('teacher_id', auth()->user()->id)->get();
    $all_Chapter = Chapter::where('teacher_id', auth()->user()->id)->get();

    $n_Lectures = Lecture::where('teacher_id', auth()->user()->id)->count();
    $n_Chapter = Chapter::where('teacher_id', auth()->user()->id)->count();
