      ...
      if ($n_non_students == 0) {
         ...
         foreach ($non_students as $non_student) {
            ...
            $students[] = [
               ...
               'profile_pic' => $non_student->profile_pic ? asset("/uploads/profile_picture/" . $non_student->profile_pic) : null,
               'mobile' => $non_student->mobile,
      ...
      if ($n_students == 0) {
         ...
         foreach ($students as $student) {
            ...
            $allstudents[] = [
               ...
               'profile_pic' => $student->profile_pic ? asset("/uploads/profile_picture/" . $student->profile_pic) : null,
